...
public class TargetList {
	...
	/**
	 * @return the targetUIID
	 */
	public int getTargetUIID() {
		return targetUIID;
	}
	/**
	 * @param targetUIID the targetUIID to set
	 */
	public void setTargetUIID(int targetUIID) {
		this.targetUIID = targetUIID;
	}
