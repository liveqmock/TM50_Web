...
/* ********  E N C O D I N G   M E T H O D S  ******** */    
    ...
    {
    	int maxLine = getShortString(source, MAX_LINE_LENGTH) ;
    	
        int    len43   = len * 4 / 3;
        byte[] outBuff = new byte[   ( len43 )                      // Main 4:3
                                   + ( (len % 3) > 0 ? 4 : 0 )      // Account for padding
                                   + (breakLines ? ( len43 / maxLine ) : 0) ]; // New lines      
        int d = 0;
        int e = 0;
        int len2 = len - 2;
        int lineLength = 0;
        for( ; d < len2; d+=3, e+=4 )
        {
            ...
            lineLength += 4;
            System.out.println(" breakLines : "+ breakLines);
            System.out.println(" lineLength : "+ lineLength);
            System.out.println(" MAX_LINE_LENGTH : "+ maxLine);
            if( breakLines && lineLength == maxLine )
            {   
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    private static int getShortString( byte[] byteString, int length)
    {
