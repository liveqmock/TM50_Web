...
%>
	...
	<c:forEach items="${massmailRepeatList}" var="massmailList">
	<TR class="tbl_tr" massmailList_id="<c:out value="${massmailList.massmailID}"/>" >				
		<TD class="tbl_td" align="center"><c:out value="${massmailList.massmailID}"/></TD>	
		<TD class="tbl_td" align="left"><a href="javascript:$('<%=id%>').editWindow('<c:out value="${massmailList.massmailID}"/>')"><strong><c:out value="${massmailList.massmailTitle}" escapeXml="true"/></strong></a></TD>		
		<TD class="tbl_td"><c:out value="${massmailList.userName}"/></TD>	
		<TD class="tbl_td"><c:out value="${massmailList.repeatSendTypeDesc}"/></TD>	
		<TD class="tbl_td"><c:out value="${massmailList.repeatSendStartDate}"/></TD>	
		<TD class="tbl_td"><c:out value="${massmailList.repeatSendEndDate}"/></TD>	
	</TR>
	</c:forEach>
