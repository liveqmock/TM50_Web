...
<div class="search_wrapper" style="width:970px">
	...
	<div>
		<ul id="sSearchType"  class="selectBox" title="검색 조건 선택">
			<li data="i.masssmsTitle" select="yes">대량SMS명</li>			
...
<div style="clear:both;width:970px">
	...
	<thead>
		<tr>
		<th style="height:30px;width:50px">대량SMSID</th>
	...
	nemoWindow(
		{
			...
			type: 'modal',
			loadMethod: 'xhr',
			contentURL: 'masssms/write/masssms.do?id=<%=id%>_schedule_modal&preID=<%=id%>&method=editRepeat&masssmsID='+seq
		}
	);
...
$('<%=id%>').list = function ( forPage ) {	
	...
	nemoRequest.init( 
	{
		...
		url: 'masssms/write/masssms.do?method=listRepeat&id=<%=id%>', 
