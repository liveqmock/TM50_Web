...
%>
	...
	-->
	<c:forEach items="${loginHistoryList}" var="loginHistory">
		<TR class="tbl_tr" >
			<TD class="tbl_td"><c:out value="${loginHistory.userID}"/></TD>
				<TD class="tbl_td"><c:out value="${loginHistory.accessIP}"/></TD>	
			<TD class="tbl_td"><c:out value="${loginHistory.registDate}"/></TD>	
			<TD class="tbl_td"><c:out value="${loginHistory.loginYN}"/></TD>		
			<TD class="tbl_td"><c:out value="${loginHistory.description}"/></TD>
		</TR>
	</c:forEach>
